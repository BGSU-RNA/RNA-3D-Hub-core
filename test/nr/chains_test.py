...
class ChainsTest(StageTest):
    ...
    def setUp(self):
        ...
        self.grouping = {
            ('NR_1.5_01181.1', '0.1'): [{'id': 1, 'rank': 3}],
            ('NR_1.5_08345.1', '0.1'): [{'id': 2, 'rank': 2}],
            ('NR_1.5_23793.1', '0.1'): [{'id': 3, 'rank': 0}]
        }
    ...
    def test_fails_if_entry_is_not_in_mapping(self):
        copy = dict(self.grouping[('NR_1.5_23793.1', '0.1')])
        self.grouping[('bob', '1.0')] = copy
        self.assertRaises(core.InvalidState, self.loader.chains,
