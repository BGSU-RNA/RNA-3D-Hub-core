% pPlotMotifMatchQuality plots the logarithmic histogram of scores of many sequences against the model in Search, the scores of the actual sequences from the structures, and the scores of given sequences which may be a good match to the model
...
Filenames = dir(['MotifLibrary' filesep 'IL*']);
...
toc
  ...
  MinAligStructDist = zeros(0,length(selfscores));

  zPlotMotifScores(aligseqs,aligcounts,selfscores,MinAligStructDist,Search.logcounts,Search.logbins)
