function [] = annotatePdbWithMotifs(pdb_id, motif_type)
%function [] = annotatePdbWithMotifs(pdb_id, exemplar_ids, motif_type)
    ...
    result.exemplar_ids = result.loop_ids;

    for i = 1:N

        % create the new matching matrix
        MM = MM_exemplars;
