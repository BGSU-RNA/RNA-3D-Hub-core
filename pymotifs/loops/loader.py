...
from pymotifs.loops.loops.add_modified_nucleotides import Loader as ModifiedNucleotidesLoader


class Loader(core.StageContainer):
    stages = set([Extractor, PositionLoader, QALoader, ModifiedNucleotidesLoader])
