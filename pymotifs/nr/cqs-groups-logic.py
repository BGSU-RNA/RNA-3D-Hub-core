"""This module contains the logic to create reports of CQS
...
#
#	As of 2018-03-28, much of this logic has been split into
#	ife.cqs (for non-release-specific items).
# 
#	The remainder should remain here to support the database
#	import of release-specific CQS components (including the
#	CQS itself).
#
#	Next step:  comment out the ife.cqs code to allow for 
#	testing of the release-specific data generation.
#
...
class Groups(core.Reporter):
    ...
    def revised_chain_info(self, ifes):
        ...
        with self.session() as session:
            query = session.query(
                ...
                #outerjoin(mod.SpeciesMapping,mod.SpeciesMapping.species_mapping_id == mod.ChainSpecies.species_id).\
    ...
    def data(self, release, resolution):
