...
B = [B;[  1.1  6.4  7.8  4.3  6.0 -3.0  3.0 -1.1 -0.7   50   80]]; % cis WC-WC adjusted 2010-07-13 renamed 2010-07-18
...
%B = [B;[  5.1  2.2  4.8  7.0  8.6 -3.0  3.0 -1.1 -0.7   70   80]]; % cis WC-S? Merge with bif category 2010-07-13
...
B = [B;[  8   -4.5 -3.0  6.5  7.8 -3.0  3.0  0.7  1.1  160  220]]; % tr  H-H  CLZ 2010-07-15
B = [B;[  8.1 -2.6 -0.7  8.1  9.7 -3.0  3.0  0.7  1.1  160  210]]; % tr  H-H  CLZ 2010-07-15
...
B = [B;[  9   -6.3 -3.5  4.8  9.5 -3.0  3.0  0.6  1.1  -60    0]]; % cis H-S CLZ 2010-10-27
